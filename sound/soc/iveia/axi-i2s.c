	...
	struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
    ...
    iBDivide = iLrDivide / (2*(NUM_BITS_MIN + 1));

    //LR_div_value = iLrDivide - 1
...
static int axi_i2s_probe(struct platform_device *pdev)
{
    ...
    //Not currently hooked up to anything, just hangs processor if core is not there
