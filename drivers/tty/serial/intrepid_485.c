 ...
 * later version.
 *
 * This driver is based on the Xilinx PS UART driver but includes modem controls for RS485. 
 *
 */
...
#define CDNS_UART_NAME		"intrepid485"
